...
%Tempi di ricerca:
% - Per query di tipo 0
%   Search HNSW on |D| nodes, with K=\Theta(KNN) and M=450
% - Per query di tipo 1
%   <  500000 -> Exaustive on O(\frac {|D|} {20})
%   >= 500000 -> Search HNSW on |D| nodes, with K=\Theta(KNN), and M=O(1800 + \frac {700 {dim}_c} {{max}_c - {min}_c})
% - Per query di tipo 2
%   <  500000 -> Exaustive on O(\frac {|D|} {20})
%   >= 500000 && |Intersect| <  2000000 -> Search HNSW on O(|D|) nodes, with K=\Theta(KNN), and M=O(780)
%   >= 500000 && |Intersect| >= 2000000 -> Search HNSW on O(|D|) nodes, with K=\Theta(KNN), and M=O(680)
% - Per query di tipo 3
%   <  500000 -> Exaustive on O(\frac {|D|} {12.5})
%   >= 500000 -> Search HNSW on |D| nodes, with K=\Theta(KNN), and M=O(1800 + \frac {1000 {dim}_c} {{max}_c - {min}_c})
