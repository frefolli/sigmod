...
altri. $M$ è stato scelto attraverso uno studio sull'impatto dei parametri sulle 
sullemetriche di tempo e recall.
...
piano geometrico, quindi avere una sola hash table per LSH, e risolvere la riduzione della 
...
$k'=\lceil \log_2\sqrt{|D|}+2\rceil$ che coincide a $14$ per $|D|= 10^7$ quindi 
i tempi sono elevati. In realtà,
effettuando una sola suddivisione dello spazio, i tempi si riducono e quindi 
si può pensare anche di ridurre il valore di $k'$.